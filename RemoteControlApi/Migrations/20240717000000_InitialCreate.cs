    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                VersionName = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                ...
                FileChecksum = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AppVersionId = table.Column<int>(type: "INTEGER", nullable: true),
