...
public partial class InitialCreate : Migration
{
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateIndex(
            name: "IX_AppVersions_ApplicationId_VersionName",
            table: "AppVersions",
            columns: new[] { "ApplicationId", "VersionName" },
            unique: true);
        ...
        migrationBuilder.CreateIndex(
            name: "IX_Notifications_ApplicationId_IsActive_CreatedAt",
            table: "Notifications",
            columns: new[] { "ApplicationId", "IsActive", "CreatedAt" });
    }
